...
INSERT INTO `lesson` (`id`, `category_id`, `name`) VALUES
	...
	(6, 2, 'Node.js Basics'),
	(7, 2, 'API Development'),
	(8, 3, 'UX Design Basics'),
	(9, 3, 'Responsive Design'),
	(10, 4, 'Web Development Basics'),
	(11, 5, 'SQL Basics'),
	...
	(17, 1, 'JavaScript DOM'),
	(18, 2, 'PHP Advanced'),
	(19, 2, 'Node.js Advanced'),
	(20, 2, 'API Security'),
	(21, 3, 'Graphic Design Basics'),
	(22, 3, 'Color Theory'),
	(23, 3, 'Typography'),
	(24, 4, 'HTML Advanced'),
	(25, 4, 'CSS Grid'),
	(26, 4, 'JavaScript ES6'),
	(27, 5, 'NoSQL Basics'),
	(28, 5, 'Database Design'),
	(29, 5, 'SQL Advanced'),
	(30, 6, 'Vue.js Basics'),
	(31, 6, 'Angular Advanced'),
	(32, 6, 'React Advanced');
...
-- Listage des données de la table session_emmanuel.program : ~13 rows (environ)
...
-- Listage des données de la table session_emmanuel.session : ~10 rows (environ)
INSERT INTO `session` (`id`, `teacher_id`, `formation_id`, `name`, `place`, `date_start`, `date_end`) VALUES
	(1, 1, 1, 'Front-end - Beginner', 10, '2025-03-01', '2025-03-05'),
	(2, 2, 1, 'Front-end - Intermediate', 15, '2025-03-10', '2025-03-15'),
	(3, 3, 2, 'Back-end - Intermediate', 10, '2025-04-01', '2025-04-10'),
	(4, 4, 2, 'Back-end - Advanced', 15, '2025-04-15', '2025-04-20'),
	(5, 5, 3, 'Design - Beginner', 10, '2024-01-01', '2024-01-10'),
	(6, 6, 3, 'Design - Advanced', 15, '2024-02-01', '2024-02-10'),
	(7, 5, 4, 'Full-stack - Beginner', 10, '2025-01-01', '2025-12-31'),
	(8, 6, 4, 'Full-stack - Advanced', 15, '2025-01-01', '2025-12-31'),
	(9, 5, 5, 'Databases - Beginner', 10, '2026-01-01', '2026-01-10'),
	(10, 6, 5, 'Databases - Intermediate', 15, '2026-02-01', '2026-02-10');
...
-- Listage des données de la table session_emmanuel.student : ~6 rows (environ)
INSERT INTO `student` (`id`, `name`, `firstname`, `date_birth`, `city`, `email`, `gender`, `phone`) VALUES
	...
	(5, 'Petit', 'Luc', '1996-07-12', 'Nice', 'luc.petit@example.com', 'M', '0123456789'),
	(6, 'Moreau', 'Sophie', '1999-03-25', 'Nantes', 'sophie.moreau@example.com', 'F', '0987654321');
...
-- Listage des données de la table session_emmanuel.student_session : ~14 rows (environ)
...
-- Listage des données de la table session_emmanuel.teacher : ~6 rows (environ)
INSERT INTO `teacher` (`id`, `name`, `firstname`, `email`) VALUES
	...
	(5, 'Bernard', 'Jean', 'jean.bernard@example.com'),
	(6, 'Rousseau', 'Marie', 'marie.rousseau@example.com');
